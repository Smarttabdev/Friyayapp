...
export type FinderLensItemsQueryVariables = {|
  cursor?: ?string,
  sort?: ?any,
  filters?: ?any,
  refreshCount?: ?string,
  ...
  topicId?: ?string,
|};
export type FinderLensItemsQueryResponse = {|
  +$fragmentRefs: FinderLens_query$ref
|};
export type FinderLensItemsQuery = {|
  variables: FinderLensItemsQueryVariables,
  response: FinderLensItemsQueryResponse,
|};
*/
...
return {
  ...
  "params": {
    "cacheID": "83deab31ecfe6d2570a0dc8ea1d36142",
    "id": null,
    "metadata": {},
    "name": "FinderLensItemsQuery",
    "operationKind": "query",
    "text": "query FinderLensItemsQuery(\n  $cursor: String\n  $sort: JSON\n  $filters: JSON\n  $itemTypes: [ItemTypeEnum!]\n  $topicId: ID\n) {\n  ...FinderLens_query_L0YLw\n}\n\nfragment FinderLens_query_L0YLw on Query {\n  items(first: 20, after: $cursor, sort: $sort, filters: $filters, itemTypes: $itemTypes, topicId: $topicId) {\n    totalCount\n    edges {\n      node {\n        id\n        itemId\n        title\n        slug\n        baseType\n        itemType\n        createdAt\n        updatedAt\n        completedAt\n        meta\n        speed\n        completion\n        tip {\n          id\n          parent {\n            id\n            title\n          }\n          topic {\n            id\n            title\n          }\n        }\n        topic {\n          id\n          parent {\n            id\n            title\n          }\n        }\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '9a6b9fc32d35821195f025f5b3e6bb13';

...
export type ExpandedTopicItemsQueryVariables = {|
  cursor?: ?string,
  topicId?: ?string,
  sort?: ?any,
  itemTypes?: ?$ReadOnlyArray<ItemTypeEnum>,
|};
export type ExpandedTopicItemsQueryResponse = {|
  +$fragmentRefs: ExpandedTopic_query$ref
|};
export type ExpandedTopicItemsQuery = {|
  variables: ExpandedTopicItemsQueryVariables,
  response: ExpandedTopicItemsQueryResponse,
|};
*/
...
return {
  ...
  "params": {
    "cacheID": "7e56a6a9f0624101ceaa201915db04a6",
    "id": null,
    "metadata": {},
    "name": "ExpandedTopicItemsQuery",
    "operationKind": "query",
    "text": "query ExpandedTopicItemsQuery(\n  $cursor: String\n  $topicId: ID\n  $sort: JSON\n  $itemTypes: [ItemTypeEnum!]\n) {\n  ...ExpandedTopic_query_2SysVS\n}\n\nfragment ExpandedTopic_query_2SysVS on Query {\n  items(first: 15, after: $cursor, topicId: $topicId, itemTypes: $itemTypes, sort: $sort) {\n    totalCount\n    edges {\n      node {\n        id\n        itemId\n        title\n        slug\n        baseType\n        itemType\n        tip {\n          id\n          parent {\n            id\n            title\n          }\n          topic {\n            id\n            title\n          }\n        }\n        topic {\n          id\n          parent {\n            id\n            title\n          }\n        }\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '0119dfcd8e8662fcb0a4348609fc0ed2';

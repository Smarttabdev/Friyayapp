...
export type ExpandedBoardItemItemsQueryVariables = {|
  cursor?: ?string,
  topicId?: ?string,
  sort?: ?any,
  itemTypes?: ?$ReadOnlyArray<ItemTypeEnum>,
|};
export type ExpandedBoardItemItemsQueryResponse = {|
  +$fragmentRefs: ExpandedBoardItem_query$ref
|};
export type ExpandedBoardItemItemsQuery = {|
  variables: ExpandedBoardItemItemsQueryVariables,
  response: ExpandedBoardItemItemsQueryResponse,
|};
*/
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ExpandedBoardItemItemsQuery",
    "selections": [
      {
        "args": [
          {
  ...
  "params": {
    "cacheID": "bc6005604fb49f5421c4131b116bbed8",
    "id": null,
    "metadata": {},
    "name": "ExpandedBoardItemItemsQuery",
    "operationKind": "query",
    "text": "query ExpandedBoardItemItemsQuery(\n  $cursor: String\n  $topicId: ID\n  $sort: JSON\n  $itemTypes: [ItemTypeEnum!]\n) {\n  ...ExpandedBoardItem_query_2SysVS\n}\n\nfragment ExpandedBoardItem_query_2SysVS on Query {\n  items(first: 3, after: $cursor, topicId: $topicId, itemTypes: $itemTypes, sort: $sort) {\n    totalCount\n    edges {\n      node {\n        id\n        itemId\n        title\n        slug\n        baseType\n        itemType\n        tip {\n          id\n          parent {\n            id\n            title\n          }\n          topic {\n            id\n            title\n          }\n        }\n        topic {\n          id\n          parent {\n            id\n            title\n          }\n        }\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '7f163f44c4edbcb9fb611924ac185ad4';

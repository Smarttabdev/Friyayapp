            ...
            <div className="calendar-card__content">
              <div className="calendar-card__main">
                <div className="calendar-card__title-wrapper">
                  ...
                  <CardTitleLink card={this.props.card} showCardTypeIcon />
                  <IconButton
              ...
              {!this.props.compactView && (
                <div className="calendar-card__extra">
                  ...
                  />
                  <PulseComponent
                    style={{ color: '#b3b3b3', marginTop: '10px' }}
                    size="medium"
...
const ConnectedCalendarCard = connect(mapState, { updateCard })(CalendarCard);

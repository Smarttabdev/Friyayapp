...
export type StarterLensItemsQueryVariables = {|
  cursor?: ?string,
  sort?: ?any,
  filters?: ?any,
  ...
  topicId?: ?string,
|};
export type StarterLensItemsQueryResponse = {|
  +$fragmentRefs: StarterLens_query$ref
|};
export type StarterLensItemsQuery = {|
  variables: StarterLensItemsQueryVariables,
  response: StarterLensItemsQueryResponse,
|};
*/
...
return {
  ...
  "params": {
    "cacheID": "c369a104ffbbd9eb8e1f1f69d0b64f0c",
    "id": null,
    "metadata": {},
    "name": "StarterLensItemsQuery",
    "operationKind": "query",
    "text": "query StarterLensItemsQuery(\n  $cursor: String\n  $sort: JSON\n  $filters: JSON\n  $itemTypes: [ItemTypeEnum!]\n  $topicId: ID\n) {\n  ...StarterLens_query_18WXhd\n}\n\nfragment ItemList_items on Item {\n  id\n  itemId\n  title\n  slug\n  baseType\n  itemType\n  createdAt\n  updatedAt\n  completedAt\n  meta\n  speed\n  completion\n  tip {\n    id\n    parent {\n      id\n      title\n    }\n    topic {\n      id\n      title\n    }\n  }\n  topic {\n    id\n    parent {\n      id\n      title\n    }\n  }\n}\n\nfragment StarterLens_query_18WXhd on Query {\n  items(first: 15, after: $cursor, sort: $sort, filters: $filters, itemTypes: $itemTypes, topicId: $topicId) {\n    totalCount\n    edges {\n      node {\n        id\n        ...ItemList_items\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '778011919a881004b7ec2521ec51459a';

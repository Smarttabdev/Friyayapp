        ...
        <div className={className}>
          <div className="document-card__wrapper">
            <div className="document-card_element title">
              ...
              <div data-tip={card.attributes.title} data-for={forId}>
                <CardTitleLink card={card} showCardTypeIcon truncate />
...
const ConnectedDocumentCard = connect(mapState, mapDispatch)(DocumentCard);

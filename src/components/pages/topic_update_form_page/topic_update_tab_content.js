...
import FieldsTabContent from 'Components/pages/main_form_page/tip_tab_content/fields_tab_content';
...
class TopicUpdateTabContent extends React.Component {
  ...
  handleTopicUpdateFormSubmit = async e => {
    ...
    const planData = this.planTabContent.getWrappedInstance().state;
          ...
          >
            <ul className="slide-indicators nav nav-pills main-form-content-nav">
              ...
              <li
                ...
                data-slide-to="5"
              >
                <a href="javascript:void(0)">Fields</a>
              </li>
            </ul>
...
export default connect(null, mapDispatch)(TopicUpdateTabContent);

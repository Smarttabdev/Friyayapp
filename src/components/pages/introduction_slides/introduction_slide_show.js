        ...
        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 full-height">
          ...
          <div className="flex-c-center col-sm-12 col-md-12 col-xs-12">
            <div className="text-center">
              <h4 className="title">
                Add cards to your Board to add a note, task, file, link, image
                and so forth.
              </h4>
              <h4 className="title">
                Visualize the cards with +30 different Board tools.
              </h4>
            </div>
            <div
            ...
            <a href="/introduction/create_yay">
              <button className="showCreateTopicPageButton">
                <p>
                  Ok let’s create your first Board

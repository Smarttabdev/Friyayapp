...
export class DomainTabContent extends Component {
  ...
  render() {
    const {
      props: { domain, handleDomainFormSubmit, tab, loadingDomain },
      state: { admins }
    } = this;
    ...
    return (
      <div className="tab-pane active" role="tabpanel" id="domain-pane">
        <form className="main-form" id="main-domain-form" method="post">
          {domainIDHiddenInput}
          <div
          ...
          >
            ...
            <div className="carousel-inner" role="listbox">
              <div className={`item ${tab == 0 && 'active'}`}>
                ...
                <div className="navbar navbar-inverse navbar-fixed-bottom">
                  <div className="domain-submit__button">
                    <input
                      onClick={handleDomainFormSubmit}
                      type="submit"
                      name="submit"
                    ...
                    />
                    {loadingDomain && (
                      <i className="fa fa-spinner fa-pulse mt6 domain__spinner-icon" />
                    )}
                  </div>
                </div>
              </div>
              ...
              {domain && (
                <Fragment>
                  <div className={`item ${tab == 2 && 'active'}`}>
                    <div className="panel-body">
                      <SharingSelectMenu
                        update
                        sharingFor="admin"
                  ...
                  <div className={`item ${tab == 3 && 'active'}`}>
                    <div className="panel-body">
                      <PermissionsList
                  ...
                  <div className={`item ${tab == 4 && 'active'}`}>
                    <div className="panel-body">

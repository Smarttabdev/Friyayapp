...
class GroupUpdateTabContent extends PureComponent {
  ...
  render() {
    ...
    //add isMemberActive props into group_update_form_page to activate member tab by default
    let generalStyle = 'active';
    let memberStyle;
    if (isMemberActive) {
      generalStyle = '';
      memberStyle = 'active';
    ...
    const selectedSharingItems = user_followers.data.map(userId => ({
      id: `users-${userId}`,
      name: people[userId]
        ? get(people[userId], 'attributes.name', 'Unknown User')
        : 'Unknown User'
    }));
        ...
        >
          ...
          >
            ...
            <div className="carousel-inner" role="listbox">
              <div className={`item ${generalStyle}`}>
              ...
              <div className={`item ${memberStyle}`}>
                <div className="panel-body">
                  <SharingSelectMenu

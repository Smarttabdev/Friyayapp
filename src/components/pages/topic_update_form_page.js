  ...
  render() {
    ...
    if (Ability.can('delete', 'self', topic)) {
      topicMoveAction = (
        <span className="mr5">
          <a
            className="btn btn-primary btn-rounded navbar-btn dropdown-toggle"
      ...
      topicDeleteAction = (
        <span>
          <a
            className="btn btn-danger navbar-btn dropdown-toggle btn-rounded"
            data-toggle="dropdown"
            aria-haspopup="true"
            aria-expanded="false"
            data-submenu
          ...
          <ul className="dropdown-menu">
            <li>
              <a onClick={this.handleTopicDelete}>
                Delete this Board and all it&apos;s Boards and Archive all Cards
                in this Board
              </a>
            </li>
            ...
            <li className="dropdown-submenu">
              <a
                ...
                data-persist="true"
              >
                Delete this Board and Move all Boards and Cards here to another
                Board
              </a>
      ...
      >
        <nav className="navbar navbar-fixed-top">
          <div className="container-fluid">
            ...
            <ul className="nav navbar-nav topic__update-title" role="tablist">
...
export default connect(mapState, mapDispatch)(TopicUpdateFormPage);

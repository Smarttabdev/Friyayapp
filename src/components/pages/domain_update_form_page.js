...
class DomainUpdateFormPage extends Component {
  ...
  handleDomainFormSubmit = e => {
    ...
    const domainID = $('#main-domain-form #domain_id')
      .val()
      .trim();
    const domainName = $('#main-domain-form #domain_name')
      .val()
      .trim();
    const domainTenantName = $('#main-domain-form #domain_tenant_name')
      .val()
      .trim();
    ...
    const domainSSOSettings = {
      ...
      domainIDPEntityID: $('#main-domain-form #domain_idp_entity_id')
        .val()
        .trim(),
      domainIDPSSOTargetURL: $('#main-domain-form #domain_idp_sso_target_url')
        .val()
        .trim(),
      domainIDPSLOTargetURL: $('#main-domain-form #domain_idp_slo_target_url')
        .val()
        .trim(),
      domainIssuer: $('#main-domain-form #domain_issuer')
        .val()
        .trim()
    };

    const adminUserIDs = $('#main-domain-form #admin_sharing_item_ids').val();
    const permissionID = $('#main-domain-form .permissions-domain').data(
      'permission-id'
    );
  ...
  handleClickArchive = e => {
    ...
    vex.dialog.confirm({
      message: 'Are you sure you want to archive this workspace?',
  ...
  render() {
    return (
      ...
      >
        <nav className="navbar navbar-fixed-top domain-update-form-page">
          <div className="container-fluid border-radius">
            ...
            <div className="pull-right buttons">
              ...
              <button
                className="btn btn-default btn-alt danger btn-alt-sm pl10 pr10"
        ...
        <div
          className="tab-content domain-update-form-page"
          id="main-form-tab-content"
        >
          <DomainTabContent

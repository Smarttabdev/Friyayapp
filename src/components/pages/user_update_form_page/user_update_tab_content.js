...
import DesktopNotificationSelect from './desktop_notification_select';
...
class UserUpdateTabContent extends Component {
  static propTypes = {
    ...
    updateUserSettingsLocal: PropTypes.func.isRequired
  };
  ...
  componentDidMount() {
    ...
    this.setState(state => ({
      ...
      lastName: last_name,
      email: email,
      avatar: avatar_url || user_profile.data.attributes.avatar_url
    }));
    ...
    $('#avatar-upload').fileupload({
      ...
      paramName: 'data[attributes[avatar]]',
        ...
        if (jqXHR && jqXHR.responseJSON) {
          ...
          setTimeout(() => {
            updateUserAvatar(updatedUserData);
    ...
    $('.setting-selectize-local').selectize({
      onChange: function(value) {
        const $input = this.$input;
        const selectKey = $input.data('select-key');
        updateUserSettingsLocal({ id, setting: selectKey, value });
      }
    });
  }
            ...
            <div className="carousel-inner" role="listbox">
              ...
              <div className="item">
                <div className="panel-body">
                  ...
                  <NotificationSettingSelect
                    selectLabel="Someone shared a Board with you"
                    selectKey="someone_shared_topic_with_me"
                  />

                  <NotificationSettingSelect
                    selectLabel="Someone adds a Card to a Board you are following"
                  ...
                  <NotificationSettingSelect
                    selectLabel="Someone assigns a card to you"
                    selectKey="someone_assigned_tip"
                  />

                  <DesktopNotificationSelect
                    selectLabel="When would you like to receive desktop notification"
                    selectKey="show_desktop_notification"
                  />
                </div>
              </div>
            </div>
...
const mapDispatch = {
  ...
  updateUserSettingsLocal: updateSettingsLocal,
  setEditUserModalOpen: setEditUserModalOpen,
  updateUserAvatar: updateAvtarUrl
};

export default connect(mapState, mapDispatch)(UserUpdateTabContent);

...
import { updateUserIntegrationTokens } from 'Src/newRedux/database/user/thunks';
    ...
    authClient.code
      ...
      .then(async authorizedData => {
        ...
        if (oauthRedirectTo) {
          ...
          Cookies.remove('oauthRedirectTo', {
            domain: `.${window.APP_DOMAIN}`
          });
        } else {
        ...
        <div className="container">
          <div className="col-sm-12">
            <h4 className="text-center text-muted">
              <p>
                Checking OAuth2 authorization code, please wait...{' '}
...
AuthCallbackPage.propTypes = {
  ...
  saveUserTokensToDb: PropTypes.func,
  updateUserIntegrationTokens: PropTypes.func
};

const mapDispatch = {
  updateUserIntegrationTokens
};

export default connect(null, mapDispatch)(AuthCallbackPage);

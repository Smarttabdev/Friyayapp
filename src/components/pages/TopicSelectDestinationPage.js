...
const actionButtonLabels = {
  archive: 'Archive Board and move content',
  delete: 'Delete Board and move content',
  move: 'Move content'
};
...
export default connect(mapState, mapDispatch)(TopicSelectDestinationPage);

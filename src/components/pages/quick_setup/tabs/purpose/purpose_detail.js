  ...
  return (
    <div className="board-detail">
      ...
      <div className="header-tip">
        Select in the list below cards you'd like to add to the Board. In the
        next Tab 'Structure' you can further add cards.
      </div>
      <TreeView
        tree={cardSample}
...
export default connect(() => ({}), mapDispatch)(PurposeDetail);

...
class ItemLabelsListing extends Component {
  ...
  render() {
    const {
      props: { labels, isLoading, item, switchScreen, openLabelForm }
    } = this;

    return (
      <div className="grid-card-menu full-height">
        <div
        ...
        <div className="item-labels-footer">
          <a className="light-gray" onClick={this.handleAddLabelClick}>
            + Add label
          </a>
        </div>
      </div>

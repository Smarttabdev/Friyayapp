...
class WikiItem extends Component {
  ...
  getTipFollowerTips = () => {
    ...
    let nestedTips = null;
    if (
      nestedTipsArray !== undefined &&
      nestedTipsArray.tips !== undefined &&
      nestedTipsArray.tips.data.length > 0
    ) {
  ...
  render() {
    ...
    const wikiTipClassNames = classNames(
      'wiki-item-row flex-r-center-spacebetween',
      {
    ...
    if (Ability.can('update', 'self', item)) {
      ...
      addTipButton = (
        <a className="btn btn-link p0 pr5" onClick={this.handleTipAddClick}>
          +
        </a>
      );
    }
        ...
        <div className={wikiTipClassNames}>
          <div className="flex-r-center">
            <a
              ...
              className="btn-collapse pr5 flex-r-center"
            >
              <span
            ...
            <a
              onClick={() => this.props.selectTipForWikiView(item)}
              className="tip-title-content flex-r-center"
            >

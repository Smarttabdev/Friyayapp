...
class UserSelect extends PureComponent {
  ...
  render() {
    ...
    return (
      <div
        className={`dropdown label-select pr0 ${showDropdown &&
          'open'} ${className}`}
      ...
      >
        ...
        >
          {showAvatar ? (
            <span className="relative">
              ...
              />
              <Icon
                containerClasses="user-select_caret-over-avatar"
                fontAwesome
                icon="caret-down"
              />
            </span>
            ...
            <Fragment>
              <span className="label-select_name">
                {selectedUser ? selectedUser.attributes.name : 'Select user'}
              </span>
        ...
        <div
          className={`dropdown-menu label-select-dropdown assigned-user-list ${showDropdown &&
            'open'}`}

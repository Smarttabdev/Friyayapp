...
class DateInput extends Component {
  ...
  render() {
    ...
    return (
      <div className={inputClassNames} style={this.props.style}>
        {this.props.transparent && (
          <style
            dangerouslySetInnerHTML={{
              __html: `#isTransparentInput::placeholder { color: ${this.props.card_font_color} !important; }`
            }}
          />
        )}
        <SingleDatePicker
          ...
          id={this.props.transparent ? 'isTransparentInput' : this.props.id}
        />
      </div>
    );
  }

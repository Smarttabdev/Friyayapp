            ...
            >
              ...
              <li>
                ...
                >
                  ...
                  Boards, sort and filters - pages, boards, timelines, sheets,
                  categories
                </a>
              </li>
            </ul>
...
const mapState = (state, props) => {
  ...
  return {
    cards: nestedCards,
    subTopics:
      getSortedFilteredTopicsByParentTopic(state)[props.rootCard.id] || []
  };
};
...
const RowWrapped = connect(mapState, mapDispatch)(Row);

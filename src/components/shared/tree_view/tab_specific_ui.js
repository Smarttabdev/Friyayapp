...
import CardDetailsPreview from 'Components/lenses/card_lenses/Card/CardDetailsPreview';
...
const TabSpecificUI = ({
  ...
  switch (tab) {
    ...
    case 'Boards': {
      ...
      return (
        <div className="ts-ui-board-tab">
          <div className="icon-wrapper board-carousel-icon-button-wrapper">

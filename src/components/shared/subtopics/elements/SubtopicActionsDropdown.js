      ...
      <div>
            ...
            <ul className="dropdown-menu t30">
              ...
              <li>
                <a
                  ...
                  className="black"
                >
                  Delete Board and move contents
                </a>
              </li>
              <li>
                <a
                  ...
                  className="black"
                >
                  {starred_by_current_user ? 'UnStar Board' : 'Star Board'}
                </a>
              </li>
              <li>
                <a
        ...
        {isOpen && (
          <div className="hex-overlay">
            ...
            <TopicsListDropdown
              actionButtonLabel="Delete Board and Move Content"
...
export default connect(null, mapDispatch)(SubtopicActionsDropdown);

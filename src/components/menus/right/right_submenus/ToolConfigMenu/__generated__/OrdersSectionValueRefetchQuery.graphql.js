...
export type OrdersSectionValueRefetchQueryVariables = {|
  queryTopicId?: ?string,
  queryLenseId?: ?string,
...
|};
export type OrdersSectionValueRefetchQueryResponse = {|
  +$fragmentRefs: OrdersSectionValue_query$ref
|};
export type OrdersSectionValueRefetchQuery = {|
  variables: OrdersSectionValueRefetchQueryVariables,
  response: OrdersSectionValueRefetchQueryResponse,
|};
*/
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "OrdersSectionValueRefetchQuery",
    "selections": [
      {
        "args": [
          (v7/*: any*/),
  ...
  "params": {
    "cacheID": "1be53a3455a7400f1f85f0aed2c2af09",
    "id": null,
    "metadata": {},
    "name": "OrdersSectionValueRefetchQuery",
    "operationKind": "query",
    "text": "query OrdersSectionValueRefetchQuery(\n  $queryTopicId: ID\n  $queryLenseId: ID\n  $queryLenseKey: String\n  $topicId: ID\n  $lenseId: ID\n  $lenseKey: String\n  $orderType: CustomOrderEnum!\n) {\n  ...OrdersSectionValue_query_3r4tn6\n}\n\nfragment OrdersSectionValue_query_3r4tn6 on Query {\n  customOrders(orderType: $orderType, topicId: $queryTopicId, lenseId: $queryLenseId, lenseKey: $queryLenseKey) {\n    id\n    name\n  }\n  activeCustomOrder(orderType: $orderType, topicId: $topicId, lenseId: $lenseId, lenseKey: $lenseKey) {\n    id\n  }\n  defaultCustomOrder(orderType: $orderType, topicId: $topicId, lenseId: $lenseId, lenseKey: $lenseKey) {\n    id\n  }\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '9f7b77a8339092010641f4dc8f11c7dd';

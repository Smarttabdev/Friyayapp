...
const IDEAS_URL = `${window.SUPPORT_URL}/boards/${window.IDEAS_TOPIC_ID}`;
const WELCOME_URL = `${window.SUPPORT_URL}/boards/${window.WELCOME_TOPIC_ID}`;
            ...
            <li className="dropdown">
              ...
              <ul className="dropdown-menu user-dropdown-menu">
                ...
                {/* Hid links while new support comes live
                  <li>
                    <a
                      href={`${window.SUPPORT_URL}/boards/${
...
export default connect(mapState, mapDispatch)(LeftMenuUserSegment);

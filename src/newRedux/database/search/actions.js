...
export const setSearchTopicsResult = searchTopicsResult => ({
  type: actionTypes.setSearchTopicsResult,
  payload: { searchTopicsResult }
});

export const clearSearchTopicsResult = () => ({
  type: actionTypes.clearSearchTopicsResult
});

...
export const showDesktopNotification = notificationBody => ({
  type: actionTypes.showDesktopNotification,
  payload: {
    latestNotificationBody: notificationBody
  }
});

export const hideDesktopNotification = () => ({
  type: actionTypes.hideDesktopNotification
});

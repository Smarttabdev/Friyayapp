...
export const addConfirmedTopicKeyForCustomOrderChange = topicKey => ({
  type: actionTypes.addConfirmedTopicKeyForCustomOrderChange,
  payload: topicKey
});

export const addConfirmedTopicIdForPinnedLensesOrderChange = topicId => ({
  type: actionTypes.addConfirmedTopicIdForPinnedLensesOrderChange,
  payload: topicId
});

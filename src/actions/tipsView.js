...
export const selectCardView = selectView(BOARDS.CARD);
export const selectGridView = selectView(BOARDS.GRID);
export const selectListView = selectView(BOARDS.LIST);
export const selectSmallGridView = selectView(BOARDS.SMALL_GRID);
export const selectTaskView = selectView(BOARDS.TASK);
export const selectDocumentsView = selectView(BOARDS.DOCUMENTS);
...
export const toggleGrid = () => (dispatch, getState) => {
  ...
  try {
    localStorage.setItem(
      'hex_panel',
      JSON.stringify(not(currState.isHexGridVisible))
    );
  } catch (err) {
    console.error(err);
  }
...
export const selectCardViewForTopic = selectViewForTopic(BOARDS.CARD);
export const selectGridViewForTopic = selectViewForTopic(BOARDS.GRID);
export const selectSmallGridViewForTopic = selectViewForTopic(
  BOARDS.SMALL_GRID
);
export const selectListViewForTopic = selectViewForTopic(BOARDS.LIST);
export const selectTaskViewForTopic = selectViewForTopic(BOARDS.TASK);
